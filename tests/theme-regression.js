...
assert(html.includes("? createPsychedelicGradient(defs, `psy-grad-${i}-active-live`, splitAngle, a1, baseColor, nextColor, false)"), 'psychedelic active remaining segment should stay gradient');
